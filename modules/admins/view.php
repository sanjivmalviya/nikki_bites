                           			...
                           			<tbody>
                           				...
                           				<?php if(isset($admins) && count($admins) > 0){ ?>
                                             ...
                                             <!-- <td width="10%" class="text-center" style="padding: 15px;"><img src="../../<?php echo $rs['admin_profile']; ?>" alt="" width="50" height="50" class="img-circle"></td> -->
                           						...
                           						<td width="50%" style="padding: 15px;" class="text-right" ><span style="line-height: 50px;">
                                                <a href="add.php?admin_id=<?php echo $rs['admin_id']; ?>" class="btn btn-xs btn-primary">Edit</a> 
                                                <a href="manage_roles.php?admin_id=<?php echo $rs['admin_id']; ?>" class="btn btn-xs btn-danger">Manage Roles</a> 
