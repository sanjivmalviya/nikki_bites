<?php
 ...
 if(isset($request->customer_id)){
     ...
     $total_sales = "SELECT COALESCE(SUM(sales_person_order_amount),0) as total_sales FROM tbl_sales_person_target_detail det INNER JOIN tbl_orders ord ON det.sales_person_order_id = ord.order_id WHERE ord.customer_id = '$customer_id' ";
