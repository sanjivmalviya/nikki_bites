...
<?php
   ...
   if(isset($request->sales_person_id) && isset($request->today)){
         ...
         if(isset($start_date) && $start_date !="" && isset($end_date) && $end_date != ""){
            ...
            $orders = "SELECT * FROM tbl_orders WHERE sales_person_id = '$sales_person_id' AND DATE(created_at) BETWEEN '$start_date' AND '$end_date' ORDER BY created_at DESC";
            $orders = getRaw($orders);
          
         }else if($today == 0){

         	// only today's records
            $orders = "SELECT * FROM tbl_orders WHERE sales_person_id = '$sales_person_id' ORDER BY created_at DESC";
            $orders = getRaw($orders);
            ...
            $orders = "SELECT * FROM tbl_orders WHERE sales_person_id = '$sales_person_id' AND DATE(created_at) = '$today_date'  ORDER BY created_at DESC";
            $orders = getRaw($orders);
