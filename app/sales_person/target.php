<?php
   ...
   if(isset($request->sales_person_id)){
	        ...
	        // by year and month
		          ...
		          $annuall_rankings = "SELECT SUM(target_category_amount) as target_amount,sales_person_id,target_year FROM tbl_target WHERE sales_person_id = '$sales_person_id' AND target_year = '$target_year' AND  target_month = '$target_month' GROUP BY target_year ORDER BY target_id DESC";
	        ...
	        // by year 
	        	  ...
	        	  $annuall_rankings = "SELECT SUM(target_category_amount) as target_amount,sales_person_id,target_year FROM tbl_target WHERE sales_person_id = '$sales_person_id' AND target_year = '$target_year' GROUP BY target_year ORDER BY target_id DESC";
	        ...
	        // by default 
	        	...
	        	$annuall_rankings = "SELECT SUM(target_category_amount) as target_amount,sales_person_id,target_year FROM tbl_target WHERE sales_person_id = '$sales_person_id' GROUP BY target_year ORDER BY target_id DESC";
