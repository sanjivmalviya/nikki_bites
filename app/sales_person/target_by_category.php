...
<?php
   ...
   if(isset($request->sales_person_id)){
          ...
          if($month != "" && $year != ""){
          	  ...
          	  // selected category 
              $target_assigned = "SELECT target_category_id,COALESCE(SUM(target_category_amount),0) as target_assigned FROM tbl_target WHERE sales_person_id = '$sales_person_id' AND YEAR(created_at) = '$year' AND MONTH(created_at) = '$month' GROUP BY target_category_id  ";
              ...
              // selected category 
              $target_assigned = "SELECT target_category_id,COALESCE(SUM(target_category_amount),0) as target_assigned FROM tbl_target WHERE sales_person_id = '$sales_person_id' AND YEAR(created_at) = '$year' GROUP BY target_category_id  ";
              $target_assigned = getRaw($target_assigned);
              ...
              // selected category 
              $target_assigned = "SELECT target_category_id,COALESCE(SUM(target_category_amount),0) as target_assigned FROM tbl_target WHERE sales_person_id = '$sales_person_id' GROUP BY target_category_id  ";
              $target_assigned = getRaw($target_assigned);
